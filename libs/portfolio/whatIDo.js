const ItemBox = (props) => {
    ...
    return (
        <div className="box h-auto w-auto rounded-xl mx-5 2xl:mx-4 3xl:mx-5 my-4 xl:my-5 2xl:my-1 2xl:py-4 3xl:py-5 group/item">
            <div className="mt-[1.8rem] mx-[1.8rem] xl:hover:mt-[1.4rem] 2xl:mt-[2rem] 2xl:mx-[2rem] 2xl:hover:mt-[1.5rem] 3xl:mt-[3rem] 3xl:mx-[2.8rem] 3xl:hover:mt-[2rem] transition-all duration-500 ease-in-out">
                <div className="h-10 w-10"><i className={`${icon} fa-2xl text-gray-400 group-focus/item: group-hover/item:text-primary font-bold transition-all duration-500 ease-in-out`}></i></div>
                <h2 className="text-lg 2xl:text-xl font-semibold text-gray-300 group-focus/item: group-hover/item:text-white 3xl:py-5 2xl:py-4 font-poppins tracking-wide text-start">{title}</h2>
                <p className="text-base font-normal text-gray-400 group-focus/item: group-hover/item:text-gray-300 py-2 xl:py-3 2xl:py-4 font-poppins tracking-wide text-start">{desc}</p>
...
const WhatIDo = () => {
    return (
        <div className="flex flex-col items-center justify-center lg:px-[3.5rem] xl:px-[3rem] 2xl:px-[6.5rem] 3xl:px-40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 gap-0 lg:gap-2 xl:gap-3 h-auto justify-start py-10">
