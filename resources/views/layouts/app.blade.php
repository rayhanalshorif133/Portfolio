...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar"
        ...
        <div class="app-engage " id="kt_app_engage">
            ...
            <a href="#" data-bs-toggle="modal"
                ...
                <i class="pt-1 mb-2 ki-duotone ki-abstract-41 fs-1"><span
                        class="path1"></span><span class="path2"></span></i>
                Prebuilts
            </a>
            ...
            <a href="https://devs.keenthemes.com" target="_blank"
                ...
                <i class="pt-1 mb-2 ki-duotone ki-like-shapes fs-1"><span
                        class="path1"></span><span class="path2"></span></i> Get
                Help
            </a>
            <!--end::Get help-->
            ...
            <a href="https://1.envato.market/EA4JP" target="_blank"
                ...
                <i class="pt-1 mb-2 ki-duotone ki-basket fs-2"><span
                        class="path1"></span><span class="path2"></span><span
                        class="path3"></span><span class="path4"></span></i> Buy
                Now
            </a>
            <!--end::Prebuilts toggle-->
            ...
            <a href="#" id="kt_app_engage_toggle_off"
                class="p-0 app-engage-btn app-engage-btn-toggle-off text-hover-primary">
            ...
            <a href="#" id="kt_app_engage_toggle_on"
                class="p-0 app-engage-btn app-engage-btn-toggle-on text-hover-primary"
                data-bs-toggle="tooltip" data-bs-placement="left"
                data-bs-custom-class="tooltip-inverse" data-bs-dimiss="click"
                title="Explore Metronic">
                <i class="ki-duotone ki-question fs-2 text-primary"><span
                        class="path1"></span><span class="path2"></span><span
        ...
        <!--begin::Engage modals-->
        <!--begin::Modal - Sitemap-->
        <div class="bg-opacity-75 modal fade bg-dark"
            id="kt_app_engage_prebuilts_modal" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="p-5 modal-dialog modal-fullscreen p-lg-10"
                id="kt_engage_prebuilts_modal_dialog">
                <!--begin::Modal content-->
                <div class="modal-content rounded-4">
                    <!--begin::Modal header-->
                    <div
                        class="px-10 pt-5 pb-0 border-0 modal-header flex-stack"
                        id="kt_engage_prebuilts_header">
                        <!--begin::View menu-->
                        <div id="kt_app_engage_prebuilts_view_menu"
                            class="position-relative z-index-1">
                            <!--begin::Toggle-->
                            <button type="button" data-kt-element="selected"
                                class="px-0 btn btn-flex rotate-"
                                data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                data-kt-menu-placement="bottom-start"
                                data-kt-menu-offset="0px, -1px">
                                <!--begin::Title-->
                                <span class="text-gray-600 fs-6 fw-bold me-2"
                                ...
                                <!--begin::Arrow-->
                                <i
                                    class="text-gray-600 ki-duotone ki-down fs-4 rotate-180-"></i>
                                <!--end::Arrow-->
                            </button>
                            <!--end::Toggle-->
                            ...
                            <!--begin::Menu-->
                            <div
                                class="px-3 py-3 menu menu-sub menu-sub-dropdown menu-column menu-active-bg menu-state-primary menu-gray-600 menu-rounded w-150px"
                                data-kt-menu="true">
                                <!--begin::Menu item-->
                                <div class="menu-item">
                                    <!--begin::Menu link-->
                                    <a href="#"
                                        class="px-4 py-2 menu-link active"
                                        data-kt-mode="image">
                                        Image View
                                    </a>
                                    <!--end::Menu link-->
                                ...
                                <div class="menu-item">
                                    <!--begin::Menu link-->
                                    <a href="#" class="px-4 py-2 menu-link"
                                        data-kt-mode="text">
                                        Text View
                                    </a>
                                    <!--end::Menu link-->
                        ...
                        <div
                            ...
                            <i class="ki-duotone ki-cross-square fs-1"><span
                                    class="path1"></span><span class="path2"></span></i>
                        </div>
                        <!--end::Close-->
                    </div>
                    ...
                    <!--begin::Modal body-->
                    <div class="pt-0 pb-5 modal-body px-15 mt-n5"
	...
	.app-prebuilts-thumbnail {
		...
		filter: drop-shadow(0px 0px 50px rgba(49, 52, 122, 0.12));
                            ...
                            <!--begin::Image view-->
                            <div class="d-block"
                                id="kt_app_engage_prebuilts_view_image">
                                <!--begin::Tabs wrapper-->
                                <div class="d-flex flex-center"
                                    id="kt_app_engage_prebuilts_view_image_tabs">
                                    <!--begin::Tabs-->
                                    <ul class="mb-5 border-0 nav nav-tabs">
                                        <!--begin::Tab item-->
                                            ...
                                            <div class="row gy-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a
                                                        ...
                                                        data-kt-href="true"
                                                        class="overflow-hidden border preview-thumbnail bg-light d-flex flex-column rounded-3 hover-elevate-up">
                                                        <!--begin::Title-->
                                                        <h3
                                                            class="text-gray-900 ps-12 pt-9 mb-7 fw-bold letter-spacing fs-4">
                                                            Metronic Original
                                                        </h3>
                                                        <!--end::Title-->
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span
                                                            class="overflow-hidden rounded app-prebuilts-thumbnail ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px">
                                                            <img
                                                                src="/metronic8/demo1/assets/media/preview/demos/placeholder.jpg"
                                                                data-src="/metronic8/demo1/assets/media/preview/prebuilts/demos/demo1.png"
                                                                class="rounded lozad w-100" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview--> </div>
                                    ...
                                    <div class="tab-pane fade"
                                        ...
                                        <div class="mb-5 d-flex flex-center">
                                            <div class="border-bottom">
                                                <!--begin::Tabs-->
                                                <ul
                                                    class="gap-4 p-0 m-0 border-0 nav nav-tabs nav-line-tabs nav-line-tabs-2x fs-6 fw-bold">
                                                    <!--begin::Tab item-->
                                                    <li class="p-0 m-0 nav-item">
                                                        <!--begin::Tab link-->
                                                        <a
                                                            class="pt-0 pb-4 nav-link text-muted text-active-primary active"
                                                            data-bs-toggle="tab"
                                                    ...
                                                    <li class="p-0 m-0 nav-item">
                                                        <!--begin::Tab link-->
                                                        <a
                                                            class="pt-0 pb-4 nav-link text-muted text-active-primary "
                                                            data-bs-toggle="tab"
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade "
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <a
                                                            class="p-0 mb-5 btn btn-flex btn-color-dark flex-stack toggle collapsible active"
                                                            data-bs-toggle="collapse"
                                                            href="#kt_app_engage_prebuilts_tab_pages_general_user-profile">

                                                            <span
                                                                class="fw-bolder fs-2">
                                                                User Profile
                                                            </span>
                                                    ...
                                                    <div class="mb-5">
                                                        <!--begin::Collapse toggle-->
                                                        <a
                                                            class="p-0 mb-5 btn btn-flex btn-color-dark flex-stack toggle collapsible collapsed"
                                                            data-bs-toggle="collapse"
                            ...
                            <div class="pt-2 d-none"
                                id="kt_app_engage_prebuilts_view_text">
                                <!--begin::Heading-->
                                <h1
                                    class="mb-4 text-center fs-2x text-dark fw-bolder"
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <!--begin::List-->
                                                <div
                                                    class="gap-3 d-flex flex-column gap-lg-5">
