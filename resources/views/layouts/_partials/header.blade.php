                    ...
                    <div class="overflow-hidden menu-state-bg menu-extended overflow-lg-visible"
                        ...
                        <div class="row">
                            ...
                            <div class="px-3 py-3 mb-3 col-lg-8 mb-lg-0 py-lg-6 px-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/dashboards/ecommerce.html"
                                                class="menu-link ">
                                                <span
                                                    class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/dashboards/projects.html"
                                                class="menu-link ">
                                                <span
                                                    class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/dashboards/online-courses.html"
                                                class="menu-link ">
                                                <span
                                                    class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/dashboards/marketing.html"
                                                class="menu-link ">
                                                <span
                                                    class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/dashboards/bidding.html"
                                                class="menu-link ">
                                                <span
                                                    class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            ...
                                            <a href="/metronic8/demo1/../demo1/dashboards/pos.html"
                                                ...
                                                <span class="d-flex flex-column">
                                                    <span class="text-gray-800 fs-6 fw-bold">POS
                                                        System</span>
                                                    <span class="fs-7 fw-semibold text-muted">Campaings
                                                        &
                                                        conversions</span>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            ...
                                            <a href="/metronic8/demo1/../demo1/dashboards/call-center.html"
                                                ...
                                                <span class="d-flex flex-column">
                                                    <span class="text-gray-800 fs-6 fw-bold">Call
                                                        Center</span>
                                                    <span class="fs-7 fw-semibold text-muted">Campaings
                                                        &
                                                        conversions</span>
                            ...
                            <div class="px-3 py-3 menu-more bg-light col-lg-4 py-lg-6 px-lg-6 rounded-end">
                                <!--begin:Heading-->
                                <h4 class="mt-3 mb-3 text-gray-800 fs-6 fs-lg-4 fw-bold ms-4">More
                                    Dashboards</h4>
                                <!--end:Heading-->
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/logistics.html"
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/website-analytics.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Website
                                            Analytics
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/finance-performance.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Finance
                                            Performance
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/store-analytics.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Store
                                            Analytics
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/social.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Social
                                        </span>
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/delivery.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Delivery
                                        </span>
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/crypto.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Crypto
                                        </span>
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/school.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            School
                                        </span>
                                ...
                                <div class="p-0 m-0 menu-item">
                                    <!--begin:Menu link-->
                                    <a href="/metronic8/demo1/../demo1/dashboards/podcast.html"
                                        class="py-2 menu-link ">
                                        <span class="menu-title">
                                            Podcast
                                        </span>
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                class="menu-item menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><span
                    class="menu-link"><span class="menu-title">Pages</span><span
                        class="menu-arrow d-lg-none"></span></span><!--end:Menu link--><!--begin:Menu sub-->
                <div class="p-0 menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown"><!--begin:Pages menu-->
                    <div class="px-4 menu-active-bg px-lg-0">
                        <!--begin:Tabs nav-->
                        <div class="overflow-auto d-flex w-100">
                            <ul class="p-0 nav nav-stretch nav-line-tabs fw-bold fs-6 p-lg-10 flex-nowrap flex-grow-1">
                                <!--begin:Nav item-->
                                ...
                                <li class="nav-item mx-lg-1">
                                    <a class="py-3 nav-link py-lg-6 text-active-primary" href="#"
                                        data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_utilities">
                                        Utilities </a>
                                </li>
                                <!--end:Nav item-->
                                <!--begin:Nav item-->
                                <li class="nav-item mx-lg-1">
                                    <a class="py-3 nav-link py-lg-6 text-active-primary" href="#"
                                        data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_widgets">
                                        Widgets </a>
                                </li>
                                <!--end:Nav item-->
                            </ul>
                        ...
                        <div class="py-4 tab-content py-lg-8 px-lg-7">
                            ...
                            <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-6 col-lg-3 mb-lg-0">
                                                <!--begin:Menu heading-->
                                                <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">User
                                                    Profile</h4>
                                                <!--end:Menu heading-->
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/pages/user-profile/campaigns.html"
                                                        class="menu-link ">
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/pages/user-profile/documents.html"
                                                        class="menu-link ">
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/pages/user-profile/followers.html"
                                                        class="menu-link ">
                                            ...
                                            <div class="mb-6 col-lg-3 mb-lg-0">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/team.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/contact.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/licenses.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/sitemap.html"
                                                            class="menu-link ">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/careers/list.html"
                                                            class="menu-link ">
                                            ...
                                            <div class="mb-6 col-lg-3 mb-lg-0">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/faq/classic.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/faq/extended.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">FAQ
                                                                Extended</span>
                                                        </a>
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/blog/home.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/blog/post.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Blog
                                                                Post</span>
                                                        </a>
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/pricing.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/pricing/table.html"
                                                            class="menu-link ">
                                            ...
                                            <div class="mb-6 col-lg-3 mb-lg-0">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/social/feeds.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/social/followers.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Followers</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/pages/social/settings.html"
                                                            class="menu-link ">
                                    ...
                                    <!--begin:Col-->
                                    <div class="col-lg-4">
                                        <img src="/metronic8/demo1/assets/media/stock/600x600/img-82.jpg"
                            ...
                            <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-6 col-lg-5 mb-lg-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/account/activity.html"
                                                        class="menu-link ">
                                                        <span class="menu-title">Activity</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/account/api-keys.html"
                                                        class="menu-link ">
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/account/logs.html"
                                                        class="menu-link ">
                                    ...
                                    <!--begin:Col-->
                                    <div class="col-lg-7">
                                        <img src="/metronic8/demo1/assets/media/stock/900x600/46.jpg"
                                            class="rounded mw-100" alt />
                                    </div>
                                    <!--end:Col-->
                                </div>
                            ...
                            <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_authentication">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-6 col-lg-3 mb-lg-0">
                                        ...
                                        <div class="mb-6">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Corporate
                                                Layout</h4>
                                            <!--end:Menu heading-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/corporate/two-factor.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/corporate/new-password.html"
                                                    class="menu-link ">
                                        ...
                                        <div class="mb-0">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Overlay
                                                Layout</h4>
                                            <!--end:Menu heading-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/overlay/sign-in.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Sign-In</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/overlay/two-factor.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Two-Factor</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/overlay/new-password.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">New
                                                        Password</span>
                                                </a>
                                    ...
                                    <div class="mb-6 col-lg-3 mb-lg-0">
                                        ...
                                        <div class="mb-6">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Creative
                                                Layout</h4>
                                            <!--end:Menu heading-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/creative/sign-in.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Sign-in</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/creative/sign-up.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Sign-up</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/creative/two-factor.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Two-Factor</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/creative/new-password.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">New
                                                        Password</span>
                                                </a>
                                        ...
                                        <div class="mb-6">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Fancy
                                                Layout</h4>
                                            <!--end:Menu heading-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/fancy/sign-in.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Sign-In</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/fancy/sign-up.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Sign-Up</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/fancy/two-factor.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Two-Factor</span>
                                                </a>
                                                <!--end:Menu link-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/fancy/reset-password.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Reset
                                                        Password</span>
                                                </a>
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/layouts/fancy/new-password.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">New
                                                        Password</span>
                                                </a>
                                    ...
                                    <div class="mb-6 col-lg-3 mb-lg-0">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/extended/multi-steps-sign-up.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/welcome.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/verify-email.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/coming-soon.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/password-confirmation.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/account-deactivated.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/error-404.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/general/error-500.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Error
                                                        500</span>
                                                </a>
                                    ...
                                    <div class="mb-6 col-lg-3 mb-lg-0">
                                        ...
                                        <div class="mb-0">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Email
                                                Templates</h4>
                                            <!--end:Menu heading-->
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/welcome-message.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Welcome
                                                        Message</span>
                                                </a>
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/reset-password.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Reset
                                                        Password</span>
                                                </a>
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/subscription-confirmed.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/card-declined.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/promo-1.html"
                                                    class="menu-link ">
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/promo-2.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Promo
                                                        2</span>
                                                </a>
                                            ...
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                                <a href="/metronic8/demo1/../demo1/authentication/email/promo-3.html"
                                                    class="menu-link ">
                                                    <span class="menu-title">Promo
                                                        3</span>
                                                </a>
                            ...
                            <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-6 col-lg-4 mb-lg-0">
                                                ...
                                                <div class="mb-0">
                                                    <!--begin:Menu heading-->
                                                    <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">General
                                                        Modals</h4>
                                                    <!--end:Menu heading-->
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/general/invite-friends.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/general/view-users.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/general/select-users.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/general/upgrade-plan.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/general/share-earn.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/forms/new-target.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">New
                                                                Target</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/forms/new-card.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">New
                                                                Card</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/forms/new-address.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">New
                                                                Address</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/forms/create-api-key.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/forms/bidding.html"
                                                            class="menu-link ">
                                            ...
                                            <div class="mb-6 col-lg-4 mb-lg-0">
                                                ...
                                                <div class="mb-6">
                                                    <!--begin:Menu heading-->
                                                    <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Advanced
                                                        Modals</h4>
                                                    <!--end:Menu heading-->
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/create-app.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                App</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/create-campaign.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                Campaign</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/create-account.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                Business
                                                                Acc</span>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/create-project.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                Project</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/top-up-wallet.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/offer-a-deal.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/wizards/two-factor-authentication.html"
                                                            class="menu-link ">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/search/horizontal.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/search/vertical.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/search/users.html"
                                                            class="menu-link ">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/modals/search/select-location.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Select
                                                                Location</span>
                                                        </a>
                                            ...
                                            <div class="mb-6 col-lg-4 mb-lg-0">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/horizontal.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Horizontal</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/vertical.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Vertical</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/two-factor-authentication.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Two
                                                                Factor
                                                                Auth</span>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/create-app.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                App</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/create-campaign.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                Campaign</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/create-account.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                Account</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/create-project.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Create
                                                                Project</span>
                                                        </a>
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/utilities/wizards/offer-a-deal.html"
                                                            class="menu-link ">
                                                            <span class="menu-title">Offer
                                                                a
                                                                Deal</span>
                                    ...
                                    <div class="col-lg-5 pe-lg-5">
                                        <img src="/metronic8/demo1/assets/media/stock/600x600/img-84.jpg"
                                            class="rounded mw-100" alt />
                                    </div>
                                    <!--end:Col-->
                                </div>
                            ...
                            <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-6 col-lg-4 mb-lg-0">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/widgets/statistics.html"
                                                class="menu-link ">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/widgets/charts.html"
                                                class="menu-link ">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/widgets/tables.html"
                                                class="menu-link ">
                                    ...
                                    <!--begin:Col-->
                                    <div class="col-lg-8">
                                        <img src="/metronic8/demo1/assets/media/stock/900x600/44.jpg"
                                            class="rounded mw-100" alt />
                                    </div>
                                    <!--end:Col-->
                                </div>
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        class="menu-item menu-lg-down-accordion"><!--begin:Menu link--><span class="menu-link"><span
                        ...
                        <div
                            ...
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/list.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">My
                                        Projects</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/project.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">View
                                        Project</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/targets.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Targets</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/budget.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Budget</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/users.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Users</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/files.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Files</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/activity.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Activity</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/projects/settings.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                        ...
                        <div
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/products.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Products</span></a><!--end:Menu link--></div>
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/categories.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Categories</span></a><!--end:Menu link--></div>
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/add-product.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/add-category.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Add
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-category.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Edit
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention">
                                ...
                                <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/sales/listing.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/sales/details.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/sales/add-order.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Add
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/sales/edit-order.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Edit
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention">
                                ...
                                <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/customers/listing.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/customers/details.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Customers
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention">
                                ...
                                <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/reports/view.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/reports/sales.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Sales</span></a><!--end:Menu link--></div>
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/reports/returns.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Returns</span></a><!--end:Menu link--></div>
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/reports/customer-orders.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/ecommerce/reports/shipping.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                            ...
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/ecommerce/settings.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Settings</span></a><!--end:Menu link--></div>
                            <!--end:Menu item-->
                        </div><!--end:Menu sub-->
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        class="menu-item menu-lg-down-accordion"><!--begin:Menu link--><span class="menu-link"><span
                                class="menu-icon"><i class="ki-duotone ki-chart fs-2"><span
                                        class="path1"></span><span class="path2"></span></i></span><span
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/support-center/overview.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/support-center/tickets/list.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/support-center/tickets/view.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Ticket
                                                View</span></a><!--end:Menu link--></div><!--end:Menu item-->
                                </div><!--end:Menu sub-->
                            </div><!--end:Menu item--><!--begin:Menu item-->
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                ...
                                <div
                                    ...
                                    <!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/support-center/tutorials/list.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/support-center/tutorials/post.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Tutorials
                            ...
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/support-center/faq.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">FAQ</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/support-center/licenses.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Licenses</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/support-center/contact.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        class="menu-item menu-lg-down-accordion"><!--begin:Menu link--><span class="menu-link"><span
                                class="menu-icon"><i class="ki-duotone ki-phone fs-2"><span
                                        class="path1"></span><span class="path2"></span></i></span><span
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/contacts/getting-started.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Getting
                                        Started</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/contacts/add-contact.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Add
                                        Contact</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/contacts/edit-contact.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Edit
                                        Contact</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/contacts/view-contact.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">View
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/subscriptions/getting-started.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Getting
                                        Started</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/subscriptions/list.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Subscription
                                        List</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/subscriptions/add.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Add
                                        Subscription</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/subscriptions/view.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">View
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/customers/getting-started.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Getting
                                        Started</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/customers/list.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Customer
                                        Listing</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/customers/view.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Customer
                                        Details</span></a><!--end:Menu link--></div><!--end:Menu item-->
                        </div><!--end:Menu sub-->
                        ...
                        <div
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/invoices/view/invoice-1.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Invoice
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/invoices/view/invoice-2.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Invoice
                                    ...
                                    <!--end:Menu item--><!--begin:Menu item-->
                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                            href="/metronic8/demo1/../demo1/apps/invoices/view/invoice-3.html"><span
                                                class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
                                                class="menu-title">Invoice
                            ...
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/invoices/create.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/file-manager/folders.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Folders</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/file-manager/files.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Files</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/file-manager/blank.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Blank
                                        Directory</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/file-manager/settings.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Settings</span></a><!--end:Menu link--></div>
                            <!--end:Menu item-->
                        </div><!--end:Menu sub-->
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        class="menu-item menu-lg-down-accordion"><!--begin:Menu link--><span class="menu-link"><span
                                class="menu-icon"><i class="ki-duotone ki-sms fs-2"><span
                                        class="path1"></span><span class="path2"></span></i></span><span
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/chat/private.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Private
                                        Chat</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/chat/group.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                        class="menu-title">Group
                                        Chat</span></a><!--end:Menu link--></div>
                            <!--end:Menu item--><!--begin:Menu item-->
                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                    href="/metronic8/demo1/../demo1/apps/chat/drawer.html"><span
                                        class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                    ...
                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                            href="/metronic8/demo1/../demo1/apps/calendar.html"><span class="menu-icon"><i
                    ...
                    <div class="px-3 pt-1 pb-3 menu-active-bg py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-4">
                                        <!--begin:Heading-->
                                        <h4 class="mt-3 mb-3 text-gray-800 fs-6 fs-lg-4 fw-bold ms-4">Layouts</h4>
                                        <!--end:Heading-->

                                        <!--begin:Menu item-->
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/layouts/light-sidebar.html"
                                                class="menu-link ">
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/layouts/dark-sidebar.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/layouts/light-header.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                                <span class="menu-title">Light
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/layouts/dark-header.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                                <span class="menu-title">Dark
                                    ...
                                    <div class="mb-3 col-lg-4">
                                        <!--begin:Heading-->
                                        <h4 class="mt-3 mb-3 text-gray-800 fs-6 fs-lg-4 fw-bold ms-4">Toolbars</h4>
                                        <!--end:Heading-->

                                        <!--begin:Menu item-->
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/toolbars/classic.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/toolbars/saas.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/toolbars/accounting.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/toolbars/extended.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/toolbars/reports.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                    ...
                                    <div class="mb-3 col-lg-4">
                                        <!--begin:Heading-->
                                        <h4 class="mt-3 mb-3 text-gray-800 fs-6 fs-lg-4 fw-bold ms-4">Asides</h4>
                                        <!--end:Heading-->

                                        <!--begin:Menu item-->
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/asides/aside-1.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/asides/aside-2.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/asides/aside-3.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                                <span class="menu-title">Shipment
                                                    History</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/asides/aside-4.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                                <span class="menu-title">Courier
                                                    Activity</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="p-0 m-0 menu-item">
                                            <!--begin:Menu link-->
                                            <a href="/metronic8/demo1/../demo1/asides/aside-5.html"
                                                class="menu-link ">
                                                <span class="menu-bullet"><span
                                                        class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                                ...
                                <div class="flex-wrap gap-2 mb-5 d-flex flex-stack flex-lg-nowrap mb-lg-0 mx-lg-5">
                                    <div class="d-flex flex-column me-5">
                                        <div class="text-gray-800 fs-6 fw-bold">
                                            Layout
                                            Builder
                            ...
                            <div class="mb-3 col-lg-5 py-lg-3 pe-lg-8 d-flex align-items-center">
                                <img src="/metronic8/demo1/assets/media/stock/900x600/45.jpg" class="rounded mw-100"
                                    alt />
                            </div>
                            <!--end:Col-->
                        </div>
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                    ...
                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                            ...
                            target="_blank"><span class="menu-icon"><i class="ki-duotone ki-code fs-2"><span
                                ...
                                v8.2.0</span></a><!--end:Menu link--></div><!--end:Menu item-->
                </div><!--end:Menu sub-->
            </div><!--end:Menu item-->
        </div>
        <!--end::Menu-->
